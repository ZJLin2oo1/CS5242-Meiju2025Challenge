...
cmd="python train_baseline.py --dataset_mode=multimodal --model=acoustic
...
--A_type=wav2vec-large_frame-c-FRA --V_type=resnet50face_FRA --L_type=roberta-base-4-FRA
--num_thread=2 --corpus=MEIJU_English
--emo_output_dim=7 --int_output_dim=8 --track=2
--ce_weight=1.0 --cls_layers=128,64 --dropout_rate=0.2
--niter=10 --niter_decay=12 --print_freq=10
--batch_size=32 --lr=2e-4 --run_idx=$run_idx --weight_decay=1e-5
--name=acoustic_english --suffix=run_{gpu_ids}_{run_idx}
--cvNo=$i"
