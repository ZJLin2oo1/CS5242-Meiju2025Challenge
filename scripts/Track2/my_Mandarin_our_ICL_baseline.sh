...
--log_dir=./logs --chesquckpoints_dir=./checkpoints --gpu_ids=$gpu
...
--name=our_ICL_Mandarin --suffix=run_{gpu_ids}_{run_idx}
--pretrained_path='/home/l/linzijie/MEIJU/codebase/checkpoints/pretrain_Mandarin_run_scripts/Track2/my_Mandarin_pretrain_baseline.sh_' --best_cvNo=1
--cvNo=$i"
