...
if __name__ == '__main__':
    ...
    input_dir = config.PATH_TO_RAW_FACE[dataset]
    print(input_dir)

    # out: feature csv dir
    save_dir = os.path.join(config.PATH_TO_FEATURES[dataset], 'openface_all')
    hog_dir  = os.path.join(config.PATH_TO_FEATURES[dataset], 'openface_hog')
    pose_dir = os.path.join(config.PATH_TO_FEATURES[dataset], 'openface_pose')
    face_dir = os.path.join(config.PATH_TO_FEATURES[dataset], 'openface_face')
